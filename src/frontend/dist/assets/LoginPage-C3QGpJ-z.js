import { c as createLucideIcon, u as useAuth, e as useLoginUser, b as useNavigate, r as reactExports, j as jsxRuntimeExports, X, B as Button, f as LogIn, L as Link, d as ue } from "./index-CmX8IV45.js";
...
import { S as Sparkles } from "./sparkles-CaKxgxYg.js";
/**
...
function LoginPage() {
  ...
  const [forgotMobile, setForgotMobile] = reactExports.useState("");
  const [forgotSubmitted, setForgotSubmitted] = reactExports.useState(false);
            ...
            showForgotInfo && /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  ...
                  !forgotSubmitted ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3 pr-4", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(CircleAlert, { className: "h-4 w-4 text-primary flex-shrink-0" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-foreground text-xs", children: "Forgot Password" })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Enter your registered mobile number below." }),
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-foreground text-xs", children: "Request Received" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground leading-relaxed", children: "Your request has been received. Please contact admin to reset your password." })
                    ] })
                  ] })
                ]
              }
