import { c as createLucideIcon, u as useAuth, a as useRegisterUser, b as useNavigate, r as reactExports, j as jsxRuntimeExports, B as Button, L as Link, d as ue } from "./index-CmX8IV45.js";
...
function HomePage() {
  ...
  async function handleRegister(e) {
    e.preventDefault();
    const { name, mobile, password, confirmPassword, referralCode, position } = form;
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container px-4 md:px-6 relative", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md mx-auto", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-2xl p-7 shadow-elevated", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleRegister, className: "space-y-4", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(Label, { htmlFor: "reg-position", className: "text-sm font-medium", children: [
                    "Position ",
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-destructive", children: "*" })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
