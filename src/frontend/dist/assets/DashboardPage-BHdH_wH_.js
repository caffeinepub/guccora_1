import { c as createLucideIcon, u as useAuth, b as useNavigate, r as reactExports, i as useMyProfile, k as useMyWallet, l as useMyReferralCode, m as useDirectDownline, n as useDownlineTree, o as useMyOrders, p as useMyNotifications, q as useMarkNotificationRead, j as jsxRuntimeExports, S as Skeleton, B as Button, s as ShoppingBag, W as Wallet, L as Link, d as ue, O as OrderStatus } from "./index-CmX8IV45.js";
import { B as Badge } from "./badge-BivFuWFV.js";
import { C as Card, a as CardHeader, c as CardTitle, b as CardContent } from "./card-D0lzvxAE.js";
import { P as Pencil } from "./pencil-D6a-XD6U.js";
import { T as TrendingUp } from "./trending-up-OJbmMIiC.js";
import { C as ChartColumn, U as Users, B as Bell, a as ChevronUp, b as ChevronDown } from "./users-C7iD8J8J.js";
import { C as Copy } from "./copy-ZFIy-ZE3.js";
import { C as Clock } from "./clock-BxPQsVVX.js";
/**
...
function DashboardPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-background min-h-[calc(100vh-7rem)]", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-card border-b border-border px-4 py-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container max-w-4xl mx-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-1", children: [
          ...
          isAdmin && /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "bg-primary/20 text-primary border-primary/30 text-xs", children: "Admin" })
        ] }),
    ...
    !profileLoading && isAuthenticated && !profile && /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        className: "bg-primary/8 border-b border-primary/20 px-4 py-3",
        "data-ocid": "profile-incomplete-banner",
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container max-w-4xl mx-auto flex items-center justify-between gap-3 flex-wrap", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 min-w-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Pencil, { className: "h-4 w-4 text-primary flex-shrink-0" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-foreground font-medium", children: [
              "Your profile is not set up yet.",
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground font-normal", children: "Register an account to start earning commissions." })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Button,
