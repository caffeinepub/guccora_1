...
const EMPTY_FORM: ProductFormData = { name: "", price: "", imageUrl: "" };
...
function ProductForm({
  ...
  form: { name: string; price: string; imageUrl: string };
  onChange: (f: { name: string; price: string; imageUrl: string }) => void;
}) {
  return (
